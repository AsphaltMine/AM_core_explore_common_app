...
document.addEventListener('DOMContentLoaded', function() {
    ...
    $('#download-excel-confirm-yes').on('click', function() {
        ...
        var format = $('input[name="excel-format"]:checked').val() || 'simple';
        var url, payload;
        if (excelDownloadState.allSelected) {
            ...
            payload = { query_id: query_id, format: format };
            ...
            payload = { id_list: Array.from(excelDownloadState.selectedIds), format: format };
        }
